...
export async function getMultiModelCompletion(
  options: MultiModelCompletionOptions
  ...
  const results: MultiModelCompletionResult[] = [];
...
export function combineCompletions(results: MultiModelCompletionResult[]): string {
  let combined = '';
